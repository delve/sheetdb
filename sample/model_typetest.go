...
//   id | string_value | bool_value | int_value | int_8_value | int_16_value | int_32_value | int_64_value | uint_value | uint_8_value | uint_16_value | uint_32_value | uint_64_value | float_32_value | float_64_value | date_value | datetime_value | custom_value | p_bool_value | p_int_value | p_int_8_value | p_int_16_value | p_int_32_value | p_int_64_value | p_uint_value | p_uint_8_value | p_uint_16_value | p_uint_32_value | p_uint_64_value | p_float_32_value | p_float_64_value | p_date_value | p_datetime_value | p_custom_value | updated_at | deleted_at
...
const (
	...
	_TypeTest_column_CustomValue    = 17 // R
	_TypeTest_column_PBoolValue     = 18 // S
	_TypeTest_column_PIntValue      = 19 // T
	_TypeTest_column_PInt8Value     = 20 // U
	_TypeTest_column_PInt16Value    = 21 // V
	_TypeTest_column_PInt32Value    = 22 // W
	_TypeTest_column_PInt64Value    = 23 // X
	_TypeTest_column_PUintValue     = 24 // Y
	_TypeTest_column_PUint8Value    = 25 // Z
	_TypeTest_column_PUint16Value   = 26 // AA
	_TypeTest_column_PUint32Value   = 27 // AB
	_TypeTest_column_PUint64Value   = 28 // AC
	_TypeTest_column_PFloat32Value  = 29 // AD
	_TypeTest_column_PFloat64Value  = 30 // AE
	_TypeTest_column_PDateValue     = 31 // AF
	_TypeTest_column_PDatetimeValue = 32 // AG
	_TypeTest_column_PCustomValue   = 33 // AH
	_TypeTest_column_UpdatedAt      = 34 // AI
	_TypeTest_column_DeletedAt      = 35 // AJ
)
...
func _TypeTest_load(data *gsheets.Sheet) error {
	...
	for i, r := range data.Rows() {
		...
		customValue, err := _TypeTest_parseCustomValue(r.Value(_TypeTest_column_CustomValue))
		if err != nil {
			return err
		}
		...
		pCustomValue, err := _TypeTest_parsePCustomValue(r.Value(_TypeTest_column_PCustomValue))
		if err != nil {
			return err
		}
...
func UpdateTypeTest(id int, stringValue string, boolValue bool, intValue int, int8Value int8, int16Value int16, int32Value int32, int64Value int64, uintValue uint, uint8Value uint8, uint16Value uint16, uint32Value uint32, uint64Value uint64, float32Value float32, float64Value float64, dateValue sheetdb.Date, datetimeValue sheetdb.Datetime, customValue Sex, pBoolValue *bool, pIntValue *int, pInt8Value *int8, pInt16Value *int16, pInt32Value *int32, pInt64Value *int64, pUIntValue *uint, pUInt8Value *uint8, pUInt16Value *uint16, pUInt32Value *uint32, pUInt64Value *uint64, pFloat32Value *float32, pFloat64Value *float64, pDateValue *sheetdb.Date, pDatetimeValue *sheetdb.Datetime, pCustomValue *Sex) (*TypeTest, error) {
	...
	typeTestCopy.CustomValue = customValue
	...
	typeTestCopy.PCustomValue = pCustomValue
...
func _TypeTest_parseCustomValue(customValue string) (Sex, error) {
	v, err := NewSex(customValue)
	if err != nil {
		return v, &sheetdb.InvalidValueError{FieldName: "CustomValue", Err: err}
	}
	return v, nil
}
...
func _TypeTest_parsePCustomValue(pCustomValue string) (*Sex, error) {
	var val *Sex
	if pCustomValue != "" {
		v, err := NewSex(pCustomValue)
		if err != nil {
			return nil, &sheetdb.InvalidValueError{FieldName: "PCustomValue", Err: err}
		}
		val = &v
	}
	return val, nil
